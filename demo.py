...
if __name__ == "__main__":
    ...
    while(1):
        ...
        if command == '1':
            ...
            print "Simple 2d localization. Sensor gives noisy (x,y)"
            print "Blue: truth, red: observation, green: filtered results."
            print "Please refer to report for setting details...\n"
            demo_kalman_xy(step_mode=1)

            raw_input("Press enter to continue a different scenario...\n")
            print "Blue: truth, red: observation"
            print "Green: realistic modelling on system dynamics."
            print "Purple: corrent initial place, 'larger V' on measurement covariance."
            print "Light Blue: wrong initial place, 'smaller V' on measurement covariance."
            print "Please refer to report for setting details...\n"
            demo_kalman_xy(step_mode=2)


            raw_input("Press enter to continue a EKF demo...\n")
            print "Simple 2d localization. Sensor gives noisy distance to (0,0)"
            print "Blue: truth, red: observation, green: filtered results."
            print "Please refer to report for setting details...\n"
            demo_extend_kalman_xy(step_mode=1)

            raw_input("Press enter to continue a different scenario...\n")
            print "Blue: truth, red: observation"
            print "Green: realistic modelling on system dynamics."
            print "Purple: correct initial place, 'smaller V' on measurement covariance. "
            print "Light Blue: wrong initial place, 'larger V' on measurement covariance. [Most stubborn one and doesn't trust sensor reading...]"
            print "Please refer to report for setting details...\n"
